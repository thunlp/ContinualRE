...
class sequence_data_sampler(object):
	...
	def __next__(self): 
		...
		cur_training_data = training_data#self.remove_unseen_relation(training_data, self.seen_relations)
		cur_valid_data = valid_data#self.remove_unseen_relation(valid_data, self.seen_relations)
...
class data_sampler(object):
	...
	def __init__(self, 
		...
		# np.save('./data/simpleqa/training_file', self.training_data)
		# np.save('./data/simpleqa/test_data', self.test_data)
		# np.save('./data/simpleqa/valid_data', self.valid_data)

		self.training_data = np.load('data/simpleqa/training_file.npy', allow_pickle=True)
		self.test_data = np.load('data/simpleqa/test_data.npy', allow_pickle=True)
		self.valid_data = np.load('data/simpleqa/valid_data.npy', allow_pickle=True)
		...
		rel_index = np.load("./data/simpleqa/rel_index1.npy")
		rel_cluster_label = np.load("./data/simpleqa/rel_cluster_label.npy")
		rel_feature = np.load("./data/simpleqa/rel_feature.npy")
